                ...
                if (data.hasOwnProperty(userID)) {
                    data[userID].forEach((record) => {
                      ...
                      for (let i = 0; i < formData.EBIncentive.length; i++) {
                        ...
                        if (isDateInRange(parseInt(userDate), formData.EBIncentive[i].startDate, formData.EBIncentive[i].endDate)) {
                            element["EarlyBird Incentive"] = element["EarlyBird Incentive"] + formData.EBIncentive[i].incentive;
                        }
                    }
